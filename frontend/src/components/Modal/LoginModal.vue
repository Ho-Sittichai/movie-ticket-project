...
<template>
  <Transition name="modal">
    <div v-if="authStore.showLoginModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-[#181818] w-full max-w-md rounded-2xl border border-white/10 shadow-2xl p-8 overflow-hidden transform-gpu">
        
        <!-- Close Button -->
        <button @click="authStore.closeLoginModal" class="absolute top-4 right-4 text-gray-400 hover:text-white transition-colors">
